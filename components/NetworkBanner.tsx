  ...
  if (state === 'offline') {
    return (
      <div
        role="status"
        aria-live="polite"
        className="fixed top-0 left-0 right-0 z-[80] bg-cinnabar text-paper px-4 py-2.5 text-xs md:text-sm text-center shadow-md flex items-center justify-center gap-2"
      >
